...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-4">Edit Academic Year: {{ $academicYear->name }}</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.academic-years.update', $academicYear->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $academicYear->name) }}" required>
                        @error('name')
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" name="is_current" id="is_current" class="form-check-input" value="1" {{ old('is_current', $academicYear->is_current) ? 'checked' : '' }}>
