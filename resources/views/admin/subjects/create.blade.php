...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-4">Create Subject</h1>
                ...
                <form action="{{ route('admin.subjects.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.5" name="credits" id="credits" class="form-control @error('credits') is-invalid @enderror" value="{{ old('credits') }}" required>
                            @error('credits')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
